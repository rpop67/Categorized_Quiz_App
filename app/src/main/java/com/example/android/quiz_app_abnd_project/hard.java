...
public class hard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        q0_answer=(RadioButton)findViewById(R.id.q0o1);
        wrong1_q0=(RadioButton)findViewById(R.id.q0o2);
    ...
    public void UpdateTimer() {
        ...
        if (seconds == 1 && minute == 0) {
            Intent myIntent = new Intent(hard.this, scoreScreen.class);
    ...
    public void check() {
        ...
        if(q3_answer.getText().toString().equalsIgnoreCase("Drachma"))
        {
            score+=add;
        }
        if(q4_answer4.isChecked() && q4_answer3.isChecked() && q4_answer2.isChecked() && q4_answer5.isChecked() && q4_answer1.isChecked()&& !(wrong1_q4.isChecked()))
        {
            score+=add;
        }
    ...
    {
        Toast.makeText(hard.this, "You scored " + score+" points.", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(hard.this, scoreScreen.class);
        myIntent.putExtra("intVariableName", score);
        startActivity(myIntent);
    }
