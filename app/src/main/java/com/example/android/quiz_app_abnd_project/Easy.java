...
public class Easy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wrong1_q6 = (RadioButton) findViewById(R.id.q6o3);
        wrong2_q6 = (RadioButton) findViewById(R.id.q6o1);
    ...
    public void UpdateTimer() {
        ...
        if (seconds <= 1 && minute == 0) {
            ...
            Intent myIntent = new Intent(Easy.this, scoreScreen.class);
    ...
    public void check() {
        ...
        if (q3_answer.getText().toString().equalsIgnoreCase("federal")) {
            score += add;
        }
    ...
    public void CalcScore(View view) {
        ...
        Toast.makeText(Easy.this, "You scored " + score + " points.", Toast.LENGTH_SHORT).show();
        Intent myIntent = new Intent(Easy.this, scoreScreen.class);
        myIntent.putExtra("intVariableName", score);
        startActivity(myIntent);
    }
